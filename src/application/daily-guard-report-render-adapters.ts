    ...
    renderer: {
      ...
      render: (currentSnapshot, order) => ({
        ...
        content: [
          ...
          ...order.map((section) => {
            const label = DAILY_GUARD_PRESENTATION_CONTRACT.evidencedSectionHeadings[section as keyof typeof DAILY_GUARD_PRESENTATION_CONTRACT.evidencedSectionHeadings];
...
export function renderSyntheticDocumentAdapter(
  format: "PDF" | "DOCX",
  snapshot: ReportSnapshot,
): SyntheticDocumentAdapterOutput {
