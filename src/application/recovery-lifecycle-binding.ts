...
export function assertRecoveryEvidenceLifecycleBinding(certification: LifecycleCertification, evidence: readonly RecoveryEvidence[]): void {
  ...
  for (const item of evidence) {
    ...
    assertRecoveryEvidenceStepBinding(matching, item);
  }
}

export function assertRecoveryEvidenceStepBinding(step: LifecycleStep, evidence: RecoveryEvidence): void {
