...
export function createLocalRuntimeRecoveryRuntimeContinuityReceipt(input: {
  ...
  assertLocalRuntimeRecoveryExecutionCompletionProof(input.completionProof, input.completionProof as never, input.completionProof as never, input.completionProof as never);
