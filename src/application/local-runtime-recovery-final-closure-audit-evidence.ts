...
export function createLocalRuntimeRecoveryFinalClosureAuditEvidence(input: {
  evidenceId: string;
  auditCertification: LocalRuntimeRecoveryFinalClosureAuditCertification;
  auditRecord: LocalRuntimeRecoveryFinalClosureAuditRecord;
  closureCertification: LocalRuntimeRecoveryClosureCertification;
  closureEvidence: LocalRuntimeRecoveryClosureEvidence;
}): LocalRuntimeRecoveryFinalClosureAuditEvidence {
  ...
  if (!input.auditCertification.certified || !input.auditCertification.syntheticOnly || input.auditCertification.replayDisposition === "CONFLICT") throw new Error("Final closure audit evidence requires non-conflicted certified state.");
