...
export function createLocalRuntimeRecoveryOperationalAuditPublicationEnvelope(input: { publicationId: string; certification: LocalRuntimeRecoveryOperationalAuditProjectionCertification; projection: LocalRuntimeRecoveryOperationalAuditProjection }): LocalRuntimeRecoveryOperationalAuditPublicationEnvelope {
  ...
  if (!c.certified || !c.syntheticOnly) throw new Error("Operational audit publication requires certified synthetic certification.");
...
export function assertLocalRuntimeRecoveryOperationalAuditPublicationEnvelope(input: LocalRuntimeRecoveryOperationalAuditPublicationEnvelope, certification: LocalRuntimeRecoveryOperationalAuditProjectionCertification, projection: LocalRuntimeRecoveryOperationalAuditProjection): void {
  ...
  if (!certification.certified || !certification.syntheticOnly) throw new Error("Operational audit publication certification is not admissible.");
