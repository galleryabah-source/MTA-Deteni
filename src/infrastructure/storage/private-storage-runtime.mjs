...
export function buildPrivateObjectMetadata(input){
  for(const k of ['objectId','bucket','contentType','sizeBytes','classification']){
    if(input?.[k]===undefined||input?.[k]===null||input?.[k]==='') throw new Error('STORAGE_METADATA_REQUIRED:'+k);
  }
