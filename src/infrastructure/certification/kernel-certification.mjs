...
const REQUIRED=['configContract','authContract','authzContract','auditContract','databaseAdapter','transactionIdempotency','outbox','privateStorage','observability','testHarness','ciGate'];
export function certifyKernel(input){
 for(const k of REQUIRED)if(input?.[k]!==true)throw new Error('KERNEL_CERTIFICATION_MISSING:'+k);
