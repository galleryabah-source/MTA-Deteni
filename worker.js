  ...
  async fetch(request, env) {
    ...
    if (request.method === 'GET' && contentType.includes('text/html')) {
      return new HTMLRewriter()
        .on('body', {
          element(element) {
            element.append('<script src="https://cdn.jsdelivr.net/npm/qrcode-generator@1.4.4/qrcode.js"></script><script src="/preview-v5.js"></script><script src="/preview-v6.js"></script><script src="/qr-print-clean.js"></script>', { html: true });
          }
        })
        .transform(response);
    }
