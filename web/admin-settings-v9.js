  ...
  const body=
    '<div class="p6grid">'+
      ...
      '<div class="p6card"><h2>Pengaturan API AI</h2>'+
        ...
        '</div>'+
        '<div class="actions"><button class="btn" onclick="window.p9testAiConnection()">Test Connection</button><button class="btn" onclick="window.p9clearAiConfig()">Matikan AI &amp; Hapus Key</button><button class="btn primary" onclick="window.p9saveAiSettings()">Simpan Pengaturan API AI</button></div>'+
      '</div>'+
