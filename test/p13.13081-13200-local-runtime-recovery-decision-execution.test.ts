...
test("P13.13081-13200: conflicted or blocked decisions cannot execute", () => {
  ...
  assert.throws(() => assertLocalRuntimeRecoveryDecisionExecution({ ...({ executionId: "RUN-BLOCK", decisionId: "DEC", requestId: "REQ", certificationId: "CERT", auditEvidenceId: "AUD", envelopeId: "ENV", admitted: false, syntheticOnly: true } as const) }), /admitted/i);
});
