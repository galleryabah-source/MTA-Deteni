...
const evidence = { certificationId:"EVID-C", evidenceId:"EVID", evidenceIdSource:"EVID-SOURCE", evidenceCertificationId:"EVID-C", integrityCertificationId:"INT-C", integrityId:"INT", closureId:"CLOSE", receiptId:"RCPT", decisionCertificationId:"DEC-C", decisionId:"DEC", decisionFingerprint:"FP", evidenceState:"READY_FOR_REVIEW", authorizationGranted:false, dispatchApproved:false, externalTransportRequested:false, dispatchExecuted:false, durablePublicationCreated:false, syntheticOnly:true, replayDisposition:"ADMIT", certified:true } as const satisfies LocalRuntimeRecoveryOperationalAuditPublicationDispatchAuthorizationDecisionEvidenceClosureIntegrityReceiptClosureIntegrityEvidenceClosureCertification;
