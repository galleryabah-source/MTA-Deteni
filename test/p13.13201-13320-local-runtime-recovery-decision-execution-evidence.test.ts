...
test("P13.13201-13320: execution evidence tampering fails closed", () => {
  ...
  assert.throws(() => assertLocalRuntimeRecoveryDecisionExecutionEvidence({ ...evidence, syntheticOnly: false }, execution, decision), /synthetic-only/i);
});
