...
test("P13.10441-10800: continuity-sensitive mutation requires handoff and recovery readiness", () => {
  ...
  const request = { requestId: "REQ-2", actorId: "ACT-2", method: "POST", path: "/mta-local/mutation", headers: {}, bodyHash: "BODY-2", idempotencyKey: "IDEMP-2", device: { deviceId: "DEV-2", installationId: "INST-2", networkScopeId: "NET-2", deviceClass: "SMARTPHONE" }, boundary: { serviceId: "SERVICE-2", listenScope: "LAN_ONLY", requiresAuthenticatedDevice: true, allowsInternetExposure: false } } as LocalRuntimeRequest;
