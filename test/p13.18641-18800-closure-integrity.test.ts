...
const decisionCertification = ({{ certificationId: "DECCERT-I", decisionId: "DEC-I", authorizationCertificationId: "AUTHCERT-I", authorizationId: "AUTH-I", candidateId: "CAND-I", requestId: "REQ-I", publicationCertificationId: "PUBCERT-I", publicationId: "PUB-I", decisionFingerprint: "FP-I", decisionState: "REVIEW_REQUIRED", authorizationGranted: false, dispatchApproved: false, externalTransportRequested: false, dispatchExecuted: false, syntheticOnly: true} as unknown as typeof integrity, replayDisposition: "ADMIT", certified: true } as const as LocalRuntimeRecoveryOperationalAuditPublicationDispatchAuthorizationDecisionCertification;
const closureCertification = ({{ certificationId: "CLOSECERT-I", closureId: "CLOSE-I", decisionCertificationId: "DECCERT-I", decisionId: "DEC-I", authorizationCertificationId: "AUTHCERT-I", authorizationId: "AUTH-I", candidateId: "CAND-I", requestId: "REQ-I", publicationCertificationId: "PUBCERT-I", publicationId: "PUB-I", decisionFingerprint: "FP-I", evidenceId: "EVID-I", evidenceState: "READY_FOR_REVIEW", closureState: "CLOSED_FOR_REVIEW", authorizationGranted: false, dispatchApproved: false, externalTransportRequested: false, dispatchExecuted: false, durablePublicationCreated: false, syntheticOnly: true} as unknown as typeof integrity, replayDisposition: "ADMIT", certified: true } as const as LocalRuntimeRecoveryOperationalAuditPublicationDispatchAuthorizationDecisionEvidenceClosureCertification;
...
test("P13.18721-18800: integrity certification is replay-safe and rejects drift/execution", () => {
  ...
  assert.throws(() => assertLocalRuntimeRecoveryOperationalAuditPublicationDispatchAuthorizationDecisionEvidenceClosureIntegrity({ ...integrity, dispatchExecuted: true }, decisionCertification), /invalid|executable/i);
