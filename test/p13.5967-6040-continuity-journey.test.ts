...
const boundary = { serviceId: "mta-local-runtime", listenScope: "LAN_ONLY" as const, allowsInternetExposure: false as const, requiresAuthenticatedDevice: true as const };
