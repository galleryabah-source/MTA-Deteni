...
| MTA-F-20260926-003 | 2026-09-26 | **Statistik Data Deteni & Ekosistem Kegiatan** | Data & Penempatan / Operational Statistics | ☑ IMPLEMENTED | Menu dan halaman statistik yang merangkum populasi Deteni, status, kebangsaan, usia, jenis kelamin, penempatan blok/kamar, pergerakan, izin, dokumen terkait, tren input, serta indikator ekosistem. Dilengkapi tabel data operasional yang dapat di-download dan dicetak sebagai dokumen A4 landscape terformat, bukan mencetak window aplikasi. Tidak memasukkan audit trail, log, telemetry, authentication, event aplikasi, atau proses kesisteman MTA. | `web/detainee-statistics-v1.js`, `web/index.html`, `test/detainee-statistics-feature.test.mjs` |
